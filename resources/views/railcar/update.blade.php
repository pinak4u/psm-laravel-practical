                    ...
                    <form action="{{route('railcars.update',$railCar->id)}}" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input id="name" placeholder="Enter Name Here Please" type="text" value="{{ $railCar->name ?: old('name') }}" class="form-control" name="name">
                                @error('name')
                        ...
                        <div class="row mt-3">
                            <div class="form-group col-md-6">
                                ...
                                <input id="arrival_date" placeholder="Select Your Arrival Date Please" type="text" value="{{ $railCar->arrival_date ?: old('arrival_date') }}" class="form-control" name="arrival_date">
                                @error('arrival_date')
                                    <span class="mt-2 error-text"  > {{$message}} </span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input id="due_date" placeholder="Select Your Due Date Please" type="text" value="{{ $railCar->due_date ?: old('due_date')}}" class="form-control" name="due_date">
                                @error('due_date')
                                    <span class="mt-2 error-text" > {{$message}} </span>
                                @enderror
                            </div>
